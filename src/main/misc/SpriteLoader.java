...
public class SpriteLoader {
    ...
    public static void loadTiles(PApplet p) {
        ...
        staticSprites.put("grassCornerBLDe_TL",p.loadImage("sprites/tiles/decoration/grassCorners/bl.png"));
        staticSprites.put("grassCornerBRDe_TL",p.loadImage("sprites/tiles/decoration/grassCorners/br.png"));
        staticSprites.put("grassCornerTLDe_TL",p.loadImage("sprites/tiles/decoration/grassCorners/tl.png"));
        staticSprites.put("grassCornerTRDe_TL",p.loadImage("sprites/tiles/decoration/grassCorners/tr.png"));
        staticSprites.put("yellowGrassCornerBLDe_TL",p.loadImage("sprites/tiles/decoration/yellowGrassCorners/bl.png"));
        staticSprites.put("yellowGrassCornerBRDe_TL",p.loadImage("sprites/tiles/decoration/yellowGrassCorners/br.png"));
        staticSprites.put("yellowGrassCornerTLDe_TL",p.loadImage("sprites/tiles/decoration/yellowGrassCorners/tl.png"));
        staticSprites.put("yellowGrassCornerTRDe_TL",p.loadImage("sprites/tiles/decoration/yellowGrassCorners/tr.png"));
        staticSprites.put("brownGrassCornerBLDe_TL",p.loadImage("sprites/tiles/decoration/brownGrassCorners/bl.png"));
        staticSprites.put("brownGrassCornerBRDe_TL",p.loadImage("sprites/tiles/decoration/brownGrassCorners/br.png"));
        staticSprites.put("brownGrassCornerTLDe_TL",p.loadImage("sprites/tiles/decoration/brownGrassCorners/tl.png"));
        staticSprites.put("brownGrassCornerTRDe_TL",p.loadImage("sprites/tiles/decoration/brownGrassCorners/tr.png"));
        staticSprites.put("deadGrassCornerBLDe_TL",p.loadImage("sprites/tiles/decoration/deadGrassCorners/bl.png"));
        staticSprites.put("deadGrassCornerBRDe_TL",p.loadImage("sprites/tiles/decoration/deadGrassCorners/br.png"));
        staticSprites.put("deadGrassCornerTLDe_TL",p.loadImage("sprites/tiles/decoration/deadGrassCorners/tl.png"));
        staticSprites.put("deadGrassCornerTRDe_TL",p.loadImage("sprites/tiles/decoration/deadGrassCorners/tr.png"));
