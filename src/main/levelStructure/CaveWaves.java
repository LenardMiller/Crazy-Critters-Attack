...
public class CaveWaves {
    ...
    public static Wave[] genCaveWaves(PApplet p) {
        ...
        waves[13] = wavePreset(p, 4200, 1800, albinoButterfly);
        ...
        waves[15] = wavePreset(p, 5000, 2000, albinoButterfly);
        waves[15].addSpawns(albinoButterfly, 10);
        waves[15].addSpawns(albinoBug, 20);

        waves[16] = wavePreset(p, 4000, 1800, midGolem);
        ...
        waves[31] = wavePreset(p, 8000, 2000, bigGolem);
        ...
        waves[32].addSpawns(bat, 20);
        waves[32].addSpawns(midGolem, 10);

        waves[33] = wavePreset(p, 8000, 1000, bigGolem);
        ...
        waves[40] = wavePreset(p, 8000, 1000, bigBat);
        waves[40].addSpawns(bigBat, 3);
        waves[40].addSpawns(bat, 5);

        waves[41] = wavePreset(p, 8000, 1000, bigBat);
        ...
        waves[43] = wavePreset(p, 8000, 2000, bigBat);
