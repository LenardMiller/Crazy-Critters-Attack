...
public class DesertWaves {
    ...
    public static Wave[] genDesertWaves(PApplet p) {
        ...
        waves[2] = new Wave(p, 65, 25, midBugFill, midBugAccent, midBugText, "Bugs");
        waves[2].addSpawns("midBug", 5);
        waves[2].addSpawns("smolBug", 15);

        waves[3] = new Wave(p, 60, 25, midBugFill, midBugAccent, midBugText, "Bugs");
        waves[3].addSpawns("midBug", 10);
        waves[3].addSpawns("smolBug", 5);

        waves[4] = new Wave(p, 55, 25, midBugFill, midBugAccent, midBugText, "Bugs");
        waves[4].addSpawns("midBug", 5);
        waves[4].addSpawns("smolBug", 15);

        waves[5] = new Wave(p, 55, 25, scorpionFill, scorpionAccent, scorpionText, "Scorpions");
        waves[5].addSpawns("scorpion", 3);
        waves[5].addSpawns("smolBug", 5);

        waves[6] = new Wave(p, 60, 25, scorpionFill, scorpionAccent, scorpionText, "Scorpions");
        waves[6].addSpawns("scorpion", 3);
        waves[6].addSpawns("midBug", 3);
        waves[6].addSpawns("smolBug", 5);

        waves[7] = new Wave(p, 60, 25, scorpionFill, scorpionAccent, scorpionText, "Scorpions");
        waves[7].addSpawns("scorpion", 5);
        waves[7].addSpawns("midBug", 3);
        waves[7].addSpawns("smolBug", 5);

        waves[8] = new Wave(p, 65, 25, midBugFill, midBugAccent, midBugText, "Bugs");
        waves[8].addSpawns("midBug", 20);
        waves[8].addSpawns("smolBug", 5);

        waves[9] = new Wave(p, 60, 10, sidewinderFill, sidewinderAccent, sidewinderText, "Sidewinders");
        waves[9].addSpawns("sidewinder", 10);

        waves[10] = new Wave(p, 60, 10, sidewinderFill, sidewinderAccent, sidewinderText, "Sidewinders");
        waves[10].addSpawns("sidewinder", 15);
        waves[10].addSpawns("scorpion", 3);

        waves[11] = new Wave(p, 60, 25, scorpionFill, scorpionAccent, scorpionText, "Scorpions");
        ...
        waves[19] = new Wave(p, 65, 20, bigBugFill, bigBugAccent, bigBugText, "Big Bugs");
        waves[19].addSpawns("bigBug", 3);
        waves[19].addSpawns("scorpion", 15);

        waves[20] = new Wave(p, 65, 5, midWormFill, midWormAccent, midWormText, "Sandworm");
        waves[20].addSpawns("midWorm", 1);
        waves[20].addSpawns("littleWorm", 5);

        waves[21] = new Wave(p, 65, 15, midWormFill, midWormAccent, midWormText, "Sandworms");
        ...
        waves[26] = new Wave(p, 45, 5, emperorFill, emperorAccent, emperorText, "Emperor");
        ...
        waves[31] = new Wave(p, 65, 20, bigWormFill, bigWormAccent, bigWormText, "Megaworm");
        ...
        waves[33].addSpawns("bigWorm", 5);

        waves[34] = new Wave(p, 60, 25, hordeFill, hordeAccent, hordeText, "Mega Horde");
